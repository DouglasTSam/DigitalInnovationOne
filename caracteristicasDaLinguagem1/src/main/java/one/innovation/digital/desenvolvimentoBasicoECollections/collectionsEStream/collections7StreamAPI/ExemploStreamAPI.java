package one.innovation.digital.desenvolvimentoBasicoECollections.collectionsEStream.collections7StreamAPI;
...
public class ExemploStreamAPI {
    public static void main(String[] args) {
        ...
        //Adiciona estudantes para coleção
        ...
        //Retorna a contagem de estudantes na coleção
        ...
        System.out.println("Estudantes com a letra R no nome : " +
                estudantes.stream().filter((estudante)->estudante.toLowerCase().contains("r")).collect(Collectors.toList()));

        //Retorna uma nova coleção, com os mesmos concatenados e quantidade de letra de cada um
        System.out.println("Retornando uma nova coleção com a quantidade de letras" +
        ...
        System.out.println("Retornando os 3 primeiros na coleção : " +
                estudantes.stream().limit(3).collect(Collectors.toList()));

        //Exibe cada elemento no console, e depois retorna a mesma coleção
        System.out.println("Retornando os elementos : " +
        ...
        System.out.println("Retornando os elementos no console : " );
        estudantes.stream().forEach(System.out::println);

        //Retorna true se todos os elementos possuem a letra 'W' no nome
        System.out.println("Todos tem a letra W no nome ? : " +
                estudantes.stream().allMatch((elemento)->elemento.contains("W")));

        //Retorna true se algum elemento possui a letra 'a' minúscula no nome
        System.out.println("Algum nome tem a letra 'a' minúscula no nome? : " +
        ...
        System.out.println("Todos não tem a letra 'a' minúscula no nome? : " +
        ...
        System.out.println("Retornando o primeiro elemento se existir : ");
        ...
        System.out.println(estudantes.stream()
                ...
                .peek(System.out::println).filter((estudante)->
